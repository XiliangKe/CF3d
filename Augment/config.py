...
parser = argparse.ArgumentParser('Pointconv')#32
...
parser.add_argument('--model_name', default='pointconv', help='classification model')
parser.add_argument('--log_dir', default='log', help='log_dir')
parser.add_argument('--data_dir', default='/userHOME/elon/modelnet40_ply_hdf5_2048')
...
parser.add_argument('--use_normal', type=bool, default=False)
